...
;(function(factory){
  ...
  // Definimos o Zippy como uma variável do tipo "função" 
   /* função anônima para garantir que a lógica dentro 
   da função seja executada imediatamente*/
   
  var Zippy = (function(element, settings){
    
    var instanceUid = 0;
    
    // função construtora para Zippy 
    function _Zippy(element, settings){
      ...
      // Criamos uma nova propriedade para manter nossas configurações padrão depois que elas
